...
function user_setup()
	...
	options.DefenseModes = {'Normal', 'PDT', 'PDTHP'}
    options.WeaponskillModes = {'Normal', 'Acc'}
    options.CastingModes = {'Normal', 'DT', 'SID'} 
    options.IdleModes = {'Normal', 'PDT'}
    options.RestingModes = {'Normal'}
    options.PhysicalDefenseModes = {'Aegis', 'Ochain'}
    ...
    sets.midcast.Reprisal =	
{
    ...
    left_ring="Evanescence Ring",
    right_ring="Apeile Ring +1",
    back={ name="Weard Mantle", augments={'VIT+5','DEX+3','Phalanx +5',}}, --5
}
