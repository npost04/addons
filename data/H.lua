...
function init_gear_sets()
    ...
    sets.precast.FC = {ammo="",
        ...
        body="",hands="",ring1="",
        back="",waist="",legs="Homam Cosciales",feet=""}
    ...
    sets.precast.WS = {
        head="Walkure Mask",neck=gear.ElementalGorget,ear1="Minuet Earring",ear2="Brutal Earring",
        body="Antares Harness",hands="Alkyoneus's Bracelets",ring1="Flame Ring",ring2="Flame Ring",
        back="Amemet Mantle +1",waist="Royal Knight's Belt +1",legs="",feet="Heroic Boots"}
    ...
    -- Normal melee group
    sets.engaged = {ammo="",
        head="Acubens Helm",neck="Peacock Charm",ear1="Minuet Earring",ear2="Brutal Earring",
        body="Homam Corazza",hands="Homam Manopolas",ring1="Sniper's Ring",ring2="Sniper's Ring",
        back="Amemet Mantle +1",waist="Speed Belt",legs="Homam Cosciales",feet="Dusk Ledelsens"}
