...
include('Augments.lua')
    ...
    sets.precast.FC = {
    head="Haruspex Hat +1", --9fc 5haste
    body="Taeon Tabard", --9fc 4haste
    hands=gear.FCTaeonGloves, --5fc 5haste
    legs="Rawhide trousers",
    feet=gear.FCTaeonBoots, --5fc 4haste
    neck="Orunmila's Torque", --5fc
    waist="Witful Belt", --3fc 3haste
    ...
    sets.precast.WS.acc = set_combine(sets.precast.WS, {hands=gear.AdhemarWristbandsMelee})
    ...
    head="Haruspex Hat +1",
    body={ name="Taeon Tabard", augments={'"Mag.Atk.Bns."+19','"Fast Cast"+5','AGI+4',}},
    hands={ name="Taeon Gloves", augments={'Mag. Acc.+12 "Mag.Atk.Bns."+12','"Fast Cast"+5','STR+1 AGI+1',}},
    legs="Enif Cosciales",
    feet={ name="Taeon Boots", augments={'"Mag.Atk.Bns."+19','"Fast Cast"+5','DEX+5',}},
...
waist="Chaac Belt"})
    ...
    ammo="Dosis Tathlum",
    head={ name="Taeon Chapeau", augments={'"Mag.Atk.Bns."+20','STR+1 DEX+1',}},
    body={ name="Hagondes Coat", augments={'Phys. dmg. taken -4%','"Mag.Atk.Bns."+22',}},
    hands={ name="Helios Gloves", augments={'"Mag.Atk.Bns."+20','"Fast Cast"+5',}},
    legs="Hagondes pants +1",
    feet={ name="Taeon Boots", augments={'"Mag.Atk.Bns."+19','"Fast Cast"+5','DEX+5',}},
    neck="Eddy Necklace",
